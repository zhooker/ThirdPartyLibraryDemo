package com.example.thirdparty.animation;
...
public class HardwareAnimationActivity extends AppCompatActivity {
    private static final String TAG = "HardwareAnimation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayout1 = configureLayout(R.id.layout_1, R.mipmap.commond, R.string.layout1_title);
        mLoremIpsum1 = mLayout1.findViewById(R.id.lorem_ipsum);
        mLayout2 = configureLayout(R.id.layout_2, R.mipmap.commone, R.string.layout2_title);
